...
def create_auth_service():
    return AuthenticationService("https://c13u09.int.janelia.org/SCSW/AuthenticationService/v1/authenticate")
...
class User(UserMixin):
    def __init__(self, token=None, username=None):
        ...
        user_fields = json.loads(base64.b64decode(
            user_token_comp).decode('UTF-8'))
        self._token = token
        self.username = username if username is not None else user_fields.get(
            'user_name')
